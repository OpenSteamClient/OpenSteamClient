...
public unsafe interface IClientNetworkDeviceManager
{
    ...
    public unknown_ret GetNetworkDevicesData([ProtobufPtrType(typeof(CMsgNetworkDevicesData))] IntPtr nativeptr);  // argc: 1, index: 3, ipc args: [], ipc returns: [bytes1, unknown]
