...
public unsafe interface IClientVideo
{
    ...
    // WARNING: Arguments are unknown!
    public unknown_ret AddTimelineHighlightMarker();  // argc: 5, index: 54, ipc args: [string, string, string, bytes4, bytes4], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret AddTimelineTimestamp();  // argc: 2, index: 55, ipc args: [string, bytes4], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret AddTimelineRange();  // argc: 7, index: 56, ipc args: [string, string, string, bytes4, bytes4, bytes4, bytes1], ipc returns: []
    // WARNING: Arguments are unknown!
