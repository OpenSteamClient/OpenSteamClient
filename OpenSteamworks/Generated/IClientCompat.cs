...
public unsafe interface IClientCompat
{
    ...
    [BlacklistedInCrossProcessIPC]
    public unknown_ret GetAvailableCompatToolsFiltered(CUtlStringList* compatTools, ERemoteStoragePlatform platform);  // argc: 2, index: 4, ipc args: [bytes4, bytes4], ipc returns: []
    [BlacklistedInCrossProcessIPC]
    public unknown_ret GetAvailableCompatToolsForApp(CUtlStringList* compatTools, AppId_t appid);  // argc: 2, index: 5, ipc args: [bytes4, bytes4], ipc returns: []
    public unknown_ret SpecifyCompatTool(AppId_t appid, string toolName, string unk, int priority);  // argc: 4, index: 6, ipc args: [bytes4, string, string, bytes4], ipc returns: []
    ...
    [BlacklistedInCrossProcessIPC]
    public bool GetWhitelistedGameList(CUtlVector<AppWhitelistSetting_t>* compatTools);  // argc: 1, index: 11, ipc args: [bytes4], ipc returns: []
    // WARNING: Arguments are unknown!
    [BlacklistedInCrossProcessIPC]
    public unknown_ret GetControllerConfigOverrides();  // argc: 1, index: 12, ipc args: [bytes4], ipc returns: []
    public UInt64 StartSession(AppId_t appid);  // argc: 1, index: 13, ipc args: [bytes4], ipc returns: [bytes8]
    // WARNING: Arguments are unknown!
    public unknown_ret ReleaseSession(AppId_t appid, UInt64 sessionid);  // argc: 3, index: 14, ipc args: [bytes4, bytes8], ipc returns: []
    public bool BIsLauncherServiceEnabled(AppId_t appid);  // argc: 1, index: 15, ipc args: [bytes4], ipc returns: [boolean]
    public unknown_ret DeleteCompatData(AppId_t appid);  // argc: 1, index: 16, ipc args: [bytes4], ipc returns: []
    public unknown_ret GetCompatibilityDataDiskSize(AppId_t appid);  // argc: 1, index: 17, ipc args: [bytes4], ipc returns: [bytes8]
