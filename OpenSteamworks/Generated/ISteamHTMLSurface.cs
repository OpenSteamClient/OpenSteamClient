...
public unsafe interface ISteamHTMLSurface005
{
    public bool Init();
    ...
    public unknown_ret MouseMove(HHTMLBrowser handle, int x, int y);
    public unknown_ret MouseWheel(HHTMLBrowser handle, int pixelsToScroll);
    public unknown_ret KeyDown(HHTMLBrowser handle, int nativeKeyCode, EHTMLKeyModifiers modifiers);
    public unknown_ret KeyUp(HHTMLBrowser handle, int nativeKeyCode, EHTMLKeyModifiers modifiers);
    public unknown_ret KeyChar(HHTMLBrowser handle, int unicodeCharPoint, EHTMLKeyModifiers modifiers);
    ...
    public unknown_ret SetKeyFocus(HHTMLBrowser handle, bool hasFocus);
    ...
    public unknown_ret JSDialogResponse(HHTMLBrowser handle, bool response);
    public unknown_ret FileLoadDialogResponse(HHTMLBrowser handle, string selectedPath);
    ...
    public unknown_ret SetBackgroundMode(HHTMLBrowser handle, bool backgroundMode);
