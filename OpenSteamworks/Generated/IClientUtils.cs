...
public unsafe interface IClientUtils
{
    ...
    public string GetIPCountry();  // argc: 0, index: 10
    ...
    // WARNING: Arguments are unknown!
    public unknown_ret SetFocusedWindow(CGameID gameid, UInt64 windowId, bool unk);  // argc: 4, index: 46
    public string GetSteamUILanguage();  // argc: 0, index: 47
    ...
    // WARNING: Arguments are unknown!
    public unknown_ret SetControllerConfigFileForAppID(AppId_t appid, string config);  // argc: 2, index: 54
    // WARNING: Arguments are unknown!
    public unknown_ret GetControllerConfigFileForAppID(AppId_t appid, StringBuilder config, int configMax);  // argc: 3, index: 55
    public bool IsSteamRunningInVR();  // argc: 0, index: 56
    public unknown_ret StartVRDashboard();  // argc: 0, index: 58
    // WARNING: Arguments are unknown!
    public unknown_ret IsVRHeadsetStreamingEnabled(AppId_t appid);  // argc: 1, index: 59
    // WARNING: Arguments are unknown!
    public unknown_ret SetVRHeadsetStreamingEnabled();  // argc: 2, index: 60
    public SteamAPICall_t GenerateSupportSystemReport();  // argc: 0, index: 61
    // WARNING: Arguments are unknown!
    public unknown_ret GetSupportSystemReport(StringBuilder str, int strMax, byte[] bytes, int bytesMax);  // argc: 4, index: 62
    // WARNING: Arguments are unknown!
    ...
    public bool BIsClientUIInForeground();  // argc: 0, index: 65
    // WARNING: Arguments are unknown!
    public void AllowSetForegroundThroughWebhelper(bool val);  // argc: 1, index: 66
    // WARNING: Arguments are unknown!
    ...
    // WARNING: Arguments are unknown!
    public unknown_ret SetOverlayNotificationPosition(AppId_t appid, ENotificationPosition pos);  // argc: 2, index: 70
    // WARNING: Arguments are unknown!
    public unknown_ret SetOverlayNotificationInset(AppId_t appid, int nHorizontalInset, int nVerticalInset);  // argc: 3, index: 71
    // WARNING: Arguments are unknown!
    public unknown_ret DispatchClientUINotification(EClientUINotificationType type, string data, uint unk);  // argc: 3, index: 72
    // WARNING: Arguments are unknown!
    public unknown_ret RespondToClientUINotification();  // argc: 3, index: 73
    // WARNING: Arguments are unknown!
    public unknown_ret DispatchClientUICommand(string data, uint unk);  // argc: 2, index: 74
    public unknown_ret DispatchComputerActiveStateChange();  // argc: 0, index: 75
    // WARNING: Arguments are unknown!
    public unknown_ret DispatchOpenURLInClient(string data, uint unk, bool unk2);  // argc: 3, index: 76
    // WARNING: Arguments are unknown!
