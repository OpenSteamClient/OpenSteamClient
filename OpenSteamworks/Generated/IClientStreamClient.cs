...
public unsafe interface IClientStreamClient
{
    ...
    // WARNING: Arguments are unknown!
    public unknown_ret BGetStreamingClientConfig();  // argc: 1, index: 5, ipc args: [], ipc returns: [boolean, unknown]
    // WARNING: Arguments are unknown!
    ...
    // WARNING: Arguments are unknown!
    public unknown_ret BQueueControllerConfigMessageForLocal();  // argc: 1, index: 0, ipc args: [protobuf], ipc returns: [bytes8]
    // WARNING: Arguments are unknown!
    public unknown_ret BGetControllerConfigMessageForRemote();  // argc: 1, index: 1, ipc args: [], ipc returns: [boolean, unknown]
    public unknown_ret GetSystemInfo();  // argc: 0, index: 2, ipc args: [], ipc returns: [string]
    // WARNING: Arguments are unknown!
    public unknown_ret StartStreamingSession();  // argc: 1, index: 0, ipc args: [bytes8], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret ReportStreamingSessionEvent();  // argc: 2, index: 1, ipc args: [bytes8, string], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret FinishStreamingSession();  // argc: 3, index: 2, ipc args: [bytes8, string, string], ipc returns: []
}