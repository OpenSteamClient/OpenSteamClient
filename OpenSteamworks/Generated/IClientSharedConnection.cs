...
public unsafe interface IClientSharedConnection
{
    ...
    public int SendMessage(HSharedConnection connection, void *msg, size_t size);  // argc: 3, index: 3, ipc args: [bytes4, bytes4, bytes_length_from_mem], ipc returns: [bytes1]
    ...
    public bool BPopReceivedMessage(HSharedConnection hConn, [IPCOut] CUtlBuffer* bufOut, out UInt32 hCall);  // argc: 3, index: 7, ipc args: [bytes4], ipc returns: [boolean, utlbuffer, bytes4]
