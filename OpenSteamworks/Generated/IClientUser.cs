...
public unsafe interface IClientUser
{
    ...
    public unknown_ret SetConfigBinaryBlob(int eRegistrySubTree, string key, CUtlBuffer* buf);  // argc: 3, index: 20, ipc args: [bytes4, string, utlbuffer], ipc returns: [bytes1]
    public unknown_ret GetConfigBinaryBlob(int eRegistrySubTree, string key, CUtlBuffer* buf);  // argc: 3, index: 21, ipc args: [bytes4, string], ipc returns: [bytes1, utlbuffer]
    // WARNING: Arguments are unknown!
    ...
    /// </summary>
    public bool GetCellList([ProtobufPtrType(typeof(CMsgCellList))] IntPtr cells);  // argc: 1, index: 74, ipc args: [], ipc returns: [bytes1, protobuf]
    ...
    // WARNING: Arguments are unknown!
    public uint GetGameBadgeLevel(AppId_t app, bool unk);  // argc: 2, index: 124, ipc args: [bytes4, bytes1], ipc returns: [bytes4]
    public uint GetPlayerSteamLevel();  // argc: 0, index: 125, ipc args: [], ipc returns: [bytes4]
    /// <summary>
    ...
    public bool BGameConnectTokensAvailable();  // argc: 0, index: 133, ipc args: [], ipc returns: [boolean]
    ...
    public bool BNeedsSSANextSteamLogon();  // argc: 0, index: 142, ipc args: [], ipc returns: [boolean]
    public void ClearNeedsSSANextSteamLogon();  // argc: 0, index: 143, ipc args: [], ipc returns: []
    ...
    // WARNING: Arguments are unknown!
    public void SetOverlayState(CGameID appid, uint unk);  // argc: 2, index: 146, ipc args: [bytes8, bytes4], ipc returns: []
    public void NotifyOverlaySettingsChanged();  // argc: 0, index: 147, ipc args: [], ipc returns: []
    ...
    public unknown_ret GetAllAccountFlags();  // argc: 0, index: 200, ipc args: [], ipc returns: [bytes4]
    public unknown_ret LockParentalLock();  // argc: 0, index: 201, ipc args: [], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret UnlockParentalLock(string unk);  // argc: 1, index: 202, ipc args: [string], ipc returns: [bytes1]
    public bool BIsParentalLockEnabled();  // argc: 0, index: 203, ipc args: [], ipc returns: [boolean]
    public bool BIsParentalLockLocked();  // argc: 0, index: 204, ipc args: [], ipc returns: [boolean]
    // WARNING: Arguments are unknown!
    public bool BIsAppBlocked(AppId_t appid);  // argc: 1, index: 205, ipc args: [bytes4], ipc returns: [boolean]
    // WARNING: Arguments are unknown!
    public bool BIsAppInBlockList(AppId_t appid);  // argc: 1, index: 206, ipc args: [bytes4], ipc returns: [boolean]
    // WARNING: Arguments are unknown!
    public bool BIsFeatureBlocked(EParentalFeature eParentalFeature);  // argc: 1, index: 207, ipc args: [bytes4], ipc returns: [boolean]
    // WARNING: Arguments are unknown!
    public bool BIsFeatureInBlockList(EParentalFeature eParentalFeature);  // argc: 1, index: 208, ipc args: [bytes4], ipc returns: [boolean]
    public unknown_ret GetParentalUnlockTime();  // argc: 0, index: 209, ipc args: [], ipc returns: [bytes4]
    public bool BGetRecoveryEmail(StringBuilder email, uint strMaxLen);  // argc: 2, index: 210, ipc args: [bytes4], ipc returns: [boolean, bytes_length_from_mem]
    public bool BIsLockFromSiteLicense();  // argc: 0, index: 211, ipc args: [], ipc returns: [boolean]
    public unknown_ret EIsParentalPlaytimeBlocked();  // argc: 0, index: 212, ipc args: [], ipc returns: [bytes4]
    public bool BGetSerializedParentalSettings(CUtlBuffer* serialized);  // argc: 1, index: 213, ipc args: [], ipc returns: [boolean, utlbuffer]
    public bool BGetParentalWebToken(CUtlBuffer* unk1, CUtlBuffer* unk2);  // argc: 2, index: 214, ipc args: [], ipc returns: [boolean, utlbuffer, utlbuffer]
    /// <summary>
    /// Only preference 0 seems to exist.
    /// </summary>
    public uint GetCommunityPreference(int preference);  // argc: 1, index: 215, ipc args: [bytes4], ipc returns: [bytes1]
    /// <summary>
    /// Only preference 0 seems to exist.
    /// </summary>
    public void SetCommunityPreference(int preference, uint value);  // argc: 2, index: 216, ipc args: [bytes4, bytes1], ipc returns: []
    public uint GetTextFilterSetting();  // argc: 0, index: 217, ipc args: [], ipc returns: [bytes4]
    public bool BTextFilterIgnoresFriends();  // argc: 0, index: 218, ipc args: [], ipc returns: [boolean]
    /// <summary>
    /// Can return 0, 1 or 2 or a mystery uint. Probably is an enum of some sort.
    /// </summary>
    public unknown_ret CanLogonOffline();  // argc: 0, index: 219, ipc args: [], ipc returns: [bytes4]
    /// <summary>
    /// Returns 19, same mystery uint as CanLogonOffline or 1
    /// Also unk1 only seems to affect the callback that gets posted.
    /// </summary>
    public unknown_ret LogOnOffline(byte unk1);  // argc: 1, index: 220, ipc args: [bytes1], ipc returns: [bytes4]
    // WARNING: Arguments are unknown!
    public unknown_ret ValidateOfflineLogonTicket();  // argc: 1, index: 221, ipc args: [string], ipc returns: [bytes4]
    // WARNING: Arguments are unknown!
    public bool BGetOfflineLogonTicket(StringBuilder ticket, int ticketMax);  // argc: 2, index: 222, ipc args: [string], ipc returns: [boolean, protobuf]
    public SteamAPICall_t UploadLocalClientLogs();  // argc: 0, index: 223, ipc args: [], ipc returns: [bytes8]
    // WARNING: Arguments are unknown!
    public void SetAsyncNotificationEnabled(AppId_t appid, bool val);  // argc: 2, index: 224, ipc args: [bytes4, bytes1], ipc returns: []
    public bool BIsOtherSessionPlaying(ref UInt32 accountID);  // argc: 1, index: 225, ipc args: [], ipc returns: [boolean, bytes4]
    public bool BKickOtherPlayingSession();  // argc: 0, index: 226, ipc args: [], ipc returns: [boolean]
    public bool BIsAccountLockedDown();  // argc: 0, index: 227, ipc args: [], ipc returns: [boolean]
    // WARNING: Arguments are unknown!
    public unknown_ret ClearAndSetAppTags();  // argc: 2, index: 228, ipc args: [bytes8, utlvector], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret RemoveAppTag();  // argc: 2, index: 229, ipc args: [bytes8, string], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret AddAppTag();  // argc: 2, index: 230, ipc args: [bytes8, string], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret ClearAppTags();  // argc: 1, index: 231, ipc args: [bytes8], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret SetAppHidden();  // argc: 2, index: 232, ipc args: [bytes8, bytes1], ipc returns: []
    public SteamAPICall_t RequestAccountLinkInfo();  // argc: 0, index: 233, ipc args: [], ipc returns: [bytes8]
    public unknown_ret RequestSurveySchedule();  // argc: 0, index: 234, ipc args: [], ipc returns: []
    public unknown_ret RequestNewSteamAnnouncementState();  // argc: 0, index: 235, ipc args: [], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret UpdateSteamAnnouncementLastRead();  // argc: 3, index: 236, ipc args: [bytes8, bytes4], ipc returns: []
    public unknown_ret GetMarketEligibility();  // argc: 0, index: 237, ipc args: [], ipc returns: [bytes8]
    // WARNING: Arguments are unknown!
    public unknown_ret UpdateGameVrDllState(CGameID gameid, bool unk, bool unk2);  // argc: 3, index: 238, ipc args: [bytes8, bytes1, bytes1], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret KillVRTheaterPancakeGame(CGameID gameid);  // argc: 1, index: 239, ipc args: [bytes8], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret SetVRIsHMDAwake();  // argc: 1, index: 240, ipc args: [bytes1], ipc returns: []
    public bool BIsAnyGameOrServiceAppRunning();  // argc: 0, index: 241, ipc args: [], ipc returns: [boolean]
    [BlacklistedInCrossProcessIPC]
    public bool BGetAppPlaytimeMap(CUtlMap<AppId_t, AppPlaytime_t>* vec);  // argc: 1, index: 242, ipc args: [bytes4], ipc returns: [boolean]
    [BlacklistedInCrossProcessIPC]
    public bool BGetAppsLastPlayedMap(CUtlMap<AppId_t, RTime32>* vec);  // argc: 1, index: 243, ipc args: [bytes4], ipc returns: [boolean]
    /// <summary>
    ...
    /// </summary>
    [BlacklistedInCrossProcessIPC]
    public bool BGetAppTagsMap(CUtlMap<AppId_t, AppTags_t>* vec);  // argc: 1, index: 244, ipc args: [bytes4], ipc returns: [boolean]
    // WARNING: Arguments are unknown!
    public unknown_ret SendSteamServiceStatusUpdate(EResult unk1, ESteamServiceStatusUpdate unk2);  // argc: 2, index: 245, ipc args: [bytes4, bytes4], ipc returns: []
    // WARNING: Arguments are unknown!
    public EResult RequestSteamGroupChatMessageNotifications();  // argc: 5, index: 246, ipc args: [bytes8, bytes8, bytes4], ipc returns: [bytes4]
    // WARNING: Arguments are unknown!
    public unknown_ret RequestSteamGroupChatMessageHistory();  // argc: 5, index: 247, ipc args: [bytes8, bytes8, bytes4], ipc returns: [bytes4]
    // WARNING: Arguments are unknown!
    public unknown_ret RequestSendSteamGroupChatMessage();  // argc: 6, index: 248, ipc args: [bytes8, bytes8, bytes4, string], ipc returns: [bytes4]
    // WARNING: Arguments are unknown!
    public unknown_ret OnNewGroupChatMsgAdded();  // argc: 8, index: 249, ipc args: [bytes8, bytes8, bytes4, bytes4, bytes4, string], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret OnGroupChatUserStateChange();  // argc: 4, index: 250, ipc args: [bytes8, bytes4, bytes4], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret OnReceivedGroupChatSubscriptionResponse();  // argc: 5, index: 251, ipc args: [bytes8, bytes8, bytes1], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret GetTimedTrialStatus();  // argc: 4, index: 252, ipc args: [bytes4], ipc returns: [bytes1, bytes1, bytes4, bytes4]
    public SteamAPICall_t RequestTimedTrialStatus(AppId_t appid);  // argc: 1, index: 253, ipc args: [bytes4], ipc returns: [bytes1]
    public unknown_ret PrepareForSystemSuspend();  // argc: 0, index: 254, ipc args: [], ipc returns: [bytes8]
    // WARNING: Arguments are unknown!
    public unknown_ret ResumeSuspendedGames();  // argc: 1, index: 255, ipc args: [bytes1], ipc returns: [bytes8]
    public UInt64 GetClientInstallationID();  // argc: 0, index: 256, ipc args: [], ipc returns: [bytes8]
    // WARNING: Arguments are unknown!
    public AppId_t GetAppIDForGameID(in CGameID gameid);  // argc: 1, index: 257, ipc args: [bytes8], ipc returns: [bytes4]
    public bool BDoNotDisturb();  // argc: 0, index: 258, ipc args: [], ipc returns: [boolean]
    // WARNING: Arguments are unknown!
    public unknown_ret SetAdditionalClientArgData(string data);  // argc: 1, index: 259, ipc args: [bytes5], ipc returns: []
    public ulong GetFamilyGroupID();  // argc: 0, index: 260, ipc args: [], ipc returns: [bytes8]
    public string GetFamilyGroupName();  // argc: 0, index: 261, ipc args: [], ipc returns: [string]
    public uint GetFamilyGroupRole();  // argc: 0, index: 262, ipc args: [], ipc returns: [bytes4]
    public int GetFamilyGroupMembers(uint[] memberAccountIDs, int maxLen);  // argc: 2, index: 263, ipc args: [bytes4], ipc returns: [bytes4, bytes_length_from_reg]
    // WARNING: Arguments are unknown!
    public bool GetSharedAppLockInfo(AppId_t appid, out bool isLocked, out uint unk, out uint unk2, out uint unk3, out bool unk4);  // argc: 5, index: 264, ipc args: [bytes4], ipc returns: [bytes1, bytes4, bytes4, bytes4, bytes1]
    // WARNING: Arguments are unknown!
    [BlacklistedInCrossProcessIPC]
    public bool GetFamilyDLCForApp(AppId_t appid, CUtlVector<uint>* dlcIDs);  // argc: 2, index: 265, ipc args: [bytes4, bytes4], ipc returns: [bytes1]
    // WARNING: Arguments are unknown!
    public SteamAPICall_t SetPreferredLender(AppId_t appid, uint accountID);  // argc: 2, index: 266, ipc args: [bytes4, bytes4], ipc returns: [bytes8]
    [BlacklistedInCrossProcessIPC]
    public unknown_ret GetFamilyCopyCounts();  // argc: 1, index: 267, ipc args: [bytes4], ipc returns: [bytes1]
    // WARNING: Arguments are unknown!
    public unknown_ret NotifyPendingGameLaunch_FetchSteamStreamingEncoderConfig();  // argc: 1, index: 268, ipc args: [bytes4], ipc returns: []
    // WARNING: Arguments are unknown!
    public bool BShouldWaitForSteamStreamingEncoderConfig();  // argc: 1, index: 269, ipc args: [bytes4], ipc returns: [boolean]
    // WARNING: Arguments are unknown!
    [BlacklistedInCrossProcessIPC]
    public bool BGetProcessIDsForGame(CGameID gameid, CUtlVector<uint>* gameIDs);  // argc: 2, index: 270, ipc args: [bytes8, bytes4], ipc returns: [boolean]
    public SteamAPICall_t CancelLicenseForApp(AppId_t appid);  // argc: 1, index: 271, ipc args: [bytes4], ipc returns: [bytes8]
}