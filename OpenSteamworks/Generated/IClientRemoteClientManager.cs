...
public unsafe interface IClientRemoteClientManager
{
    ...
    // WARNING: Arguments are unknown!
    public bool BGetStreamingClientConfig(CUtlBuffer* data);  // argc: 1, index: 65, ipc args: [], ipc returns: [boolean, unknown]
    // WARNING: Arguments are unknown!
    ...
    // WARNING: Arguments are unknown!
    public unknown_ret BGetControllerConfigMessageForLocal();  // argc: 1, index: 68, ipc args: [], ipc returns: [boolean, unknown]
    // WARNING: Arguments are unknown!
