...
public partial class AccountPickerWindowViewModel : AvaloniaCommon.ViewModelBase
{
    public ObservableCollection<SavedAccountViewModel> Accounts { get; } = new();
    private IClientUser clientUser;
    private LoginManager loginManager;
    private static Bitmap unknownBitmap = new Bitmap(AssetLoader.Open(new Uri("avares://OpenSteamClient/Assets/unknown.png")));
