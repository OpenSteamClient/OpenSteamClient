...
public:
     ...
     virtual void EnableShaderManagement() = 0; //args: 1, index: 2
     virtual void EnableShaderBackgroundProcessing() = 0; //args: 1, index: 3
     ...
     virtual void ProcessShaderCache() = 0; //args: 1, index: 10
     ...
     virtual void SkipShaderProcessing() = 0; //args: 1, index: 13
